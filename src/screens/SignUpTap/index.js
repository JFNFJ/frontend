...
class SignUpTab extends Component {
    ...
    handleResponse = response => {
        if (response.status >= 200 && response.status < 300) {
            ...
            this.props.handleShow("Usuario ya existente.");
        }
    }
            ...
            <div className="login-tab">
                <form onSubmit={this.handleSubmit}>
                    <label className="login-input">
                        Usuario:
                        <input onChange={this.handleUserSignChange} className="login-input-field" type="text"
                               name="name"/>
                    </label>
                    <label className="login-input">
                        Email:
                    ...
                    <label className="login-input">
                        Contraseña:
                        <input onChange={this.handlePassSignChange} className="login-input-field" type="password"
                               name="name"/>
                    </label>
                    <label className="login-input">
                        Confirmar:
                        <input onChange={this.handlePassConfirmSignChange} className="login-input-field" type="password"
                               name="name"/>
                    </label>
